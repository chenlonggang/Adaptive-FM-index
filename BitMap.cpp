...
/*
int BitMap::Fixed0_Rank(u64 * buff ,int &index,int bits_num)
{

	return 0;
}

int BitMap::Fixed0_Rank(u64 * buff,int & index,int bits_num,int &bit)
{

	return 0;
}

int BitMap::Fixed0_Bit(u64 * buff,int & index,int bits_num)
{
	return 0;
}

int BitMap::Fixed1_Rank(u64 * buff ,int &index,int bits_num)
{

	return 0;
}
int BitMap::Fixed1_Rank(u64 * buff,int & index,int bits_num,int &bit)
{
	return 0;
}
int BitMap::Fixed1_Bit(u64 * buff,int & index,int bits_num)
{
	return 0;
}
